...
export default function KambazNavigation() {
  ...
  const links = [
    ...
    { label: "Calendar", path: "/Kambaz/Calendar", icon: LiaCalendar },
    { label: "Inbox", path: "/Kambaz/Inbox", icon: LiaEnvelope },
    { label: "Labs", path: "/Labs", icon: LiaStickyNote },
    { label: "Back", path: "/Labs", icon: LiaArrowCircleLeftSolid }
  ];
